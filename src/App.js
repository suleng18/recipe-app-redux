...
const useStyles = makeStyles((theme) => ({
  ...
  span: { display: '-webkit-box', '-webkit-box-orient': 'vertical', '-webkit-line-clamp': '1', overflow: 'hidden' },
}));
  ...
  return (
    <div className="App">
      ...
      <form className={classes.root} noValidate autoComplete="off">
        ...
        />
        <Button variant="contained" color="primary" style={{ width: '90px', height: '56px' }} onClick={updateSearch}>
          Search
        </Button>
      </form>
            ...
            <Grid key={index} item>
              <Card className={cardClasses.root}>
                <CardHeader
                  ...
                  title={<span className={classes.span}>{item.recipe.label}</span>}
                  subheader={
                    <span>
                      <DirectionsRunIcon />
                ...
                />
                <CardMedia className={cardClasses.media} image={item.recipe.image} title={item.recipe.calories} />
                <CardContent>
